				...
				},
				{
					...
					columns: [
						...
						},
						{
							...
							header: [
								_("activitiestable_contact"),
								{
									...
									inputConfig: {
										suggest: {
											body: {
												template: obj => (obj.id === EMPTY_SELECT ? "" : `${contacts.getItem(obj.id).FirstName} ${contacts.getItem(obj.id).LastName}`)
											}
										}
									}
								}
							...
							fillspace: 1,
							collection: contacts,
							template: obj => `${contacts.getItem(obj.ContactID).FirstName} ${contacts.getItem(obj.ContactID).LastName}`
						},
						{
							id: "edit",
							header: "",
